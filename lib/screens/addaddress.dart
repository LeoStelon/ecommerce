        ...
        await _addressProvider
          ...
          if (response.statusCode == 200) {
            if (responseBody["status"] == "success" &&
              ...
              Navigator.pop(context, "isAddAddress");
            } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.title != null ? widget.title : "Add Address",
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText:
                        _validateAddress1 ? "This field is Required!" : null,
                  ...
                  onSubmitted: (value) async {
                    ...
                    if (_validateAddress1) {
                      ...
                      FocusScope.of(context).requestFocus(nodeOne3);
                        ...
                        !_validateAddress2 &&
                        !_validatePinCode) {
                      addNewAddress(address1Controller.text,
                          address2Controller.text, pincodeController.text);
                    } else {
                      print("Indvalid Data");
                      FocusScope.of(context).requestFocus(nodeOne1);
                    }
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText:
                        _validateAddress2 ? "This field is Required!" : null,
                    errorStyle: TextStyle(
                      fontSize: 15.0,
                    ),
                  ),
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText:
                        _validatePinCode ? "Please enter valid Pincode!" : null,
                    errorStyle: TextStyle(
                      fontSize: 15.0,
                    ),
                  ),
